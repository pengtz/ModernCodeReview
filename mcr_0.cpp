...
int  main(){
	...
	//char playerl = 'X';
	//char player2 = '0';
	bool turn = true; // false forplayer l's turn, true forplayer 2's turn
	...
	for(n = 0; n < 9; n++) {
    		turn = !turn; // use the not-operator to change true to false or f
    		if (turn == false){
        		cout << "Player 1: ";
    		}
    		else{
	...
	if(n == 9){
    		cout << "Tie! " << endl;
	} // allcelles with i=0 to 2 have been inputted above but no winner ye
